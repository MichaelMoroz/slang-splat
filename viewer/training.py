...
class TrainingUiConfig:
    ...
    def to_mcmc_config(self) -> MCMCConfig:
        return MCMCConfig(
            ...
            base_lr_init=float(self.base_lr_init),
            base_lr_final=float(self.base_lr_final),
            base_lr_delay_mult=float(self.base_lr_delay_mult),
            base_lr_max_steps=int(self.base_lr_max_steps),
            position_lr_mult=float(self.position_lr_mult),
            feature_lr_mult=float(self.feature_lr_mult),
            opacity_lr_mult=float(self.opacity_lr_mult),
            scaling_lr_mult=float(self.scaling_lr_mult),
            rotation_lr_mult=float(self.rotation_lr_mult),
            lambda_dssim=float(self.lambda_dssim),
            depth_ratio_weight=float(self.depth_ratio_weight),
            noise_lr=float(self.noise_lr),
            densify_enabled=bool(self.densify_enabled),
            densify_interval=int(self.densify_interval),
            densify_until_iter=int(self.densify_until_iter),
            densify_interval_after=int(self.densify_interval_after),
            densify_target_ratio=float(self.densify_target_ratio),
            densify_append_multiplier=float(self.densify_append_multiplier),
            densify_clone_opacity=float(self.densify_clone_opacity),
            remove_opacity_threshold=float(self.remove_opacity_threshold),
            max_splats=int(self.max_splats),
...
class TrainingController:
    ...
    def _apply_runtime_settings(self, trainer: RGBMCMCTrainer) -> None:
        ...
        trainer.cfg.base_lr_init = float(self.config.base_lr_init)
        trainer.cfg.base_lr_final = float(self.config.base_lr_final)
        trainer.cfg.base_lr_delay_mult = float(self.config.base_lr_delay_mult)
        trainer.cfg.base_lr_max_steps = int(self.config.base_lr_max_steps)
        trainer.cfg.position_lr_mult = float(self.config.position_lr_mult)
        trainer.cfg.feature_lr_mult = float(self.config.feature_lr_mult)
        trainer.cfg.opacity_lr_mult = float(self.config.opacity_lr_mult)
        trainer.cfg.scaling_lr_mult = float(self.config.scaling_lr_mult)
        trainer.cfg.rotation_lr_mult = float(self.config.rotation_lr_mult)
        ...
        trainer.cfg.densify_enabled = bool(self.config.densify_enabled)
        trainer.cfg.densify_interval = int(self.config.densify_interval)
        trainer.cfg.densify_until_iter = int(self.config.densify_until_iter)
        trainer.cfg.densify_interval_after = int(self.config.densify_interval_after)
        trainer.cfg.densify_target_ratio = float(self.config.densify_target_ratio)
        trainer.cfg.densify_append_multiplier = float(self.config.densify_append_multiplier)
        trainer.cfg.densify_clone_opacity = float(self.config.densify_clone_opacity)
        trainer.cfg.remove_opacity_threshold = float(self.config.remove_opacity_threshold)
        trainer.cfg.max_splats = int(self.config.max_splats)
