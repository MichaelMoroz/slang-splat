...
- `Contribution Amount` visualizes the accumulated per-pixel `transmittance * alpha` sum on a logarithmic heatmap from the active alpha cutoff up to `1.0`, making weak-but-nonzero coverage easier to inspect.
