...
class _DummyTrainer:
    def __init__(self) -> None:
        ...
        self.training = SimpleNamespace(
            ...
            lr_pos_mul=1.0,
            lr_pos_stage1_mul=1.0,
            lr_pos_stage2_mul=1.0,
            lr_pos_stage3_mul=1.0,
...
def _viewer(loss_debug: bool) -> SimpleNamespace:
    ...
    controls = {
        ...
        "lr_pos_stage1_mul": _control(1.0),
        "lr_pos_stage2_mul": _control(1.0),
        "lr_pos_stage3_mul": _control(1.0),
