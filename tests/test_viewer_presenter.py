...
class _DummyTrainer:
    def __init__(self) -> None:
        ...
        self.training = SimpleNamespace(
            ...
            maintenance_contribution_cull_threshold=128,
...
def _viewer(loss_debug: bool) -> SimpleNamespace:
    ...
    controls = {
        ...
        "maintenance_contribution_cull_threshold": _control(128),
...
def test_update_ui_text_reports_training_schedule_and_maintenance() -> None:
    ...
    assert viewer.t("training_maintenance").text == "Maintenance: every 200 | growth=0.00% now | target=2.00% after 2,000 | alpha<1.00e-02 or contrib<128 culled | max=1,000,000"
