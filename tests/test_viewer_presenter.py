...
class _DummyTrainer:
    def __init__(self) -> None:
        ...
        self.training = SimpleNamespace(
            ...
            refinement_target_edge_weight=0.5,
...
def _viewer(loss_debug: bool) -> SimpleNamespace:
    ...
    controls = {
        ...
        "refinement_loss_weight": _control(0.5),
        "refinement_target_edge_weight": _control(0.5),
        ...
        "use_sh_stage1": _control(True),
        "use_sh_stage2": _control(True),
