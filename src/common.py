...
create_default_device = lambda device_type=spy.DeviceType.vulkan, enable_debug_layers=False: spy.create_device(device_type, include_paths=(SHADER_ROOT, SHADER_ROOT / "radix_sort", SHADER_ROOT / "renderer"), enable_debug_layers=enable_debug_layers)
