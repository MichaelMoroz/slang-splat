...
DEFAULT_OPACITY_BINARIZE_REG_WEIGHT = float(TRAINING_BUILD_ARG_DEFAULTS.get("opacity_binarize_reg_weight", 0.0))
DEFAULT_TRAIN_SUBSAMPLE_CROP_PROBABILITY = float(TRAINING_BUILD_ARG_DEFAULTS.get("train_subsample_crop_probability", 0.0))
