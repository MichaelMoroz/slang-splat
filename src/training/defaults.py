...
DEFAULT_MAX_OPACITY_STAGE0 = float(TRAINING_BUILD_ARG_DEFAULTS.get("max_opacity_stage0", 0.5))
DEFAULT_MAX_OPACITY_STAGE1 = float(TRAINING_BUILD_ARG_DEFAULTS.get("max_opacity_stage1", 0.8))
DEFAULT_MAX_OPACITY_STAGE2 = float(TRAINING_BUILD_ARG_DEFAULTS.get("max_opacity_stage2", 1.0))
DEFAULT_MAX_OPACITY_STAGE3 = float(TRAINING_BUILD_ARG_DEFAULTS.get("max_opacity_stage3", 1.0))
DEFAULT_MAX_OPACITY_STAGE4 = float(TRAINING_BUILD_ARG_DEFAULTS.get("max_opacity_stage4", 1.0))
