...
DEFAULT_REFINEMENT_GRAD_VARIANCE_WEIGHT_EXPONENT = float(TRAINING_BUILD_ARG_DEFAULTS.get("refinement_grad_variance_weight_exponent", TRAINING_BUILD_ARG_DEFAULTS.get("refinement_momentum_weight_exponent", 1.5)))
