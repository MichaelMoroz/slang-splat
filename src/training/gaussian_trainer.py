...
class TrainingHyperParams:
    ...
    lr_schedule_enabled: bool = True; lr_schedule_start_lr: float = 0.005; lr_schedule_stage1_lr: float = 0.002; lr_schedule_stage2_lr: float = 0.001; lr_schedule_end_lr: float = 1e-4; lr_schedule_steps: int = 30_000; lr_schedule_stage1_step: int = 2500; lr_schedule_stage2_step: int = 15_000
