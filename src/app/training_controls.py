...
_SCHEDULE_STAGE_TEMPLATE = {
    ...
    "high_frequency_weight": {"kind": "input_float", "label": "High Freq Weight"},
    "low_frequency_weight": {"kind": "input_float", "label": "Low Freq Weight"},
...
_SCHEDULE_STAGE_CONFIGS = {
    "Stage 0": (
        ...
        ("high_frequency_weight", "high_frequency_weight", ("high_frequency_weight",), {"value": _default("high_frequency_weight"), "step": 1e-3, "step_fast": 1e-2, "format": "%.6f"}),
        ("low_frequency_weight", "low_frequency_weight", ("low_frequency_weight",), {"value": _default("low_frequency_weight"), "step": 1e-3, "step_fast": 1e-2, "format": "%.6f"}),
    ...
    "Stage 1": (
        ...
        ("high_frequency_weight", "high_frequency_weight_stage1", ("high_frequency_weight_stage1",), {"value": _default("high_frequency_weight_stage1"), "step": 1e-3, "step_fast": 1e-2, "format": "%.6f"}),
        ("low_frequency_weight", "low_frequency_weight_stage1", ("low_frequency_weight_stage1",), {"value": _default("low_frequency_weight_stage1"), "step": 1e-3, "step_fast": 1e-2, "format": "%.6f"}),
    ...
    "Stage 2": (
        ...
        ("high_frequency_weight", "high_frequency_weight_stage2", ("high_frequency_weight_stage2",), {"value": _default("high_frequency_weight_stage2"), "step": 1e-3, "step_fast": 1e-2, "format": "%.6f"}),
        ("low_frequency_weight", "low_frequency_weight_stage2", ("low_frequency_weight_stage2",), {"value": _default("low_frequency_weight_stage2"), "step": 1e-3, "step_fast": 1e-2, "format": "%.6f"}),
    ...
    "Stage 3": (
        ...
        ("high_frequency_weight", "high_frequency_weight_stage3", ("high_frequency_weight_stage3",), {"value": _default("high_frequency_weight_stage3"), "step": 1e-3, "step_fast": 1e-2, "format": "%.6f"}),
        ("low_frequency_weight", "low_frequency_weight_stage3", ("low_frequency_weight_stage3",), {"value": _default("low_frequency_weight_stage3"), "step": 1e-3, "step_fast": 1e-2, "format": "%.6f"}),
...
TRAINING_CLI_ARG_DEFS = (
    ...
    _cli_arg("--high-frequency-weight", dest="high_frequency_weight", build_arg="high_frequency_weight", type=float, default=_default("high_frequency_weight")),
    _cli_arg("--low-frequency-weight", dest="low_frequency_weight", build_arg="low_frequency_weight", type=float, default=_default("low_frequency_weight")),
