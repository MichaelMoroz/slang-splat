...
TRAIN_OPTIMIZER_CONTROL_DEFS = (
    ...
    _control("ssim_weight", "input_float", "DSSIM Weight", {"value": _default("ssim_weight"), "step": 1e-3, "step_fast": 1e-2, "format": "%.6f"}, group=TRAINING_OPTIMIZER_GROUP, build_args=("ssim_weight",), optimizer_tab="Regularization"),
    _control("ssim_c1", "input_float", "SSIM C1", {"value": _default("ssim_c1"), "step": 1e-5, "step_fast": 1e-4, "format": "%.6e"}, group=TRAINING_OPTIMIZER_GROUP, build_args=("ssim_c1",), optimizer_tab="Regularization"),
