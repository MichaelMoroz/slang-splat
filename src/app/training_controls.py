...
TRAINING_CLI_ARG_DEFS = (
    ...
    _cli_arg("--raster-grad-distance-power", dest="raster_grad_distance_power", build_arg="raster_grad_distance_power", type=float, default=_default("raster_grad_distance_power")),
    _cli_arg("--raster-grad-distance-bias", dest="raster_grad_distance_bias", build_arg="raster_grad_distance_bias", type=float, default=_default("raster_grad_distance_bias")),
    ...
    _cli_arg("--refinement-ema-pose-count-decay", dest="refinement_ema_pose_count_decay", build_arg="refinement_ema_pose_count_decay", type=float, default=_default("refinement_ema_pose_count_decay")),
    _cli_arg("--refinement-viewed-fraction-zero-threshold", dest="refinement_viewed_fraction_zero_threshold", build_arg="refinement_viewed_fraction_zero_threshold", type=float, default=_default("refinement_viewed_fraction_zero_threshold")),
