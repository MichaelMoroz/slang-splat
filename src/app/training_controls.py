...
from ..training.defaults import (
    ...
    DEFAULT_OPACITY_BINARIZE_REG_WEIGHT,
    DEFAULT_REFINEMENT_CLONE_SCALE_MUL,
    DEFAULT_TRAIN_SUBSAMPLE_CROP_PROBABILITY,
...
TRAIN_SETUP_CONTROL_DEFS = (
    ...
    _control("schedule_stretch", "input_float", "Schedule Stretch", {"value": float(TRAINING_BUILD_ARG_DEFAULTS.get("schedule_stretch", 1.0)), "step": 0.1, "step_fast": 0.5, "format": "%.2f"}, group=TRAINING_SETUP_GROUP, build_args=("schedule_stretch",)),
    ...
    _control("train_subsample_crop_probability", "input_float", "Subsample Crop Prob", {"value": DEFAULT_TRAIN_SUBSAMPLE_CROP_PROBABILITY, "step": 0.05, "step_fast": 0.25, "format": "%.3f"}, group=TRAINING_SETUP_GROUP, build_args=("train_subsample_crop_probability",)),
...
TRAIN_OPTIMIZER_CONTROL_DEFS = (
    ...
    _control("init_position_reg", "input_float", "Init Position Reg", {"value": _default("init_position_reg_weight"), "step": 1e-4, "step_fast": 1e-3, "format": "%.8f"}, group=TRAINING_OPTIMIZER_GROUP, build_args=("init_position_reg_weight",), optimizer_tab="Regularization"),
    ...
    _control("opacity_binarize_reg", "input_float", "Opacity Binarize Reg", {"value": DEFAULT_OPACITY_BINARIZE_REG_WEIGHT, "step": 1e-4, "step_fast": 1e-3, "format": "%.8f"}, group=TRAINING_OPTIMIZER_GROUP, build_args=("opacity_binarize_reg_weight",), optimizer_tab="Regularization"),
