...
class RendererParams:
    ...
    max_prepass_memory_mb: int = 4096; cached_raster_grad_atomic_mode: str = "fixed"; cached_raster_grad_fixed_scale: float = 0.125; cached_raster_grad_fixed_loffdiag_ref_scale: float = 1.0
