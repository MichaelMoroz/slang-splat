...
def build_training_params(
    *,
    ...
    high_frequency_weight: float = TRAINING_BUILD_ARG_DEFAULTS["high_frequency_weight"],
    low_frequency_weight: float = TRAINING_BUILD_ARG_DEFAULTS["low_frequency_weight"],
    ...
    high_frequency_weight_stage1: float = TRAINING_BUILD_ARG_DEFAULTS["high_frequency_weight_stage1"],
    high_frequency_weight_stage2: float = TRAINING_BUILD_ARG_DEFAULTS["high_frequency_weight_stage2"],
    high_frequency_weight_stage3: float = TRAINING_BUILD_ARG_DEFAULTS["high_frequency_weight_stage3"],
    low_frequency_weight_stage1: float = TRAINING_BUILD_ARG_DEFAULTS["low_frequency_weight_stage1"],
    low_frequency_weight_stage2: float = TRAINING_BUILD_ARG_DEFAULTS["low_frequency_weight_stage2"],
    low_frequency_weight_stage3: float = TRAINING_BUILD_ARG_DEFAULTS["low_frequency_weight_stage3"],
    ...
    training = TrainingHyperParams(
        ...
        high_frequency_weight=clamp_float(high_frequency_weight, 0.0, 1.0),
        low_frequency_weight=clamp_float(low_frequency_weight, 0.0, 1.0),
        ...
        high_frequency_weight_stage1=clamp_float(high_frequency_weight_stage1, 0.0, 1.0),
        high_frequency_weight_stage2=clamp_float(high_frequency_weight_stage2, 0.0, 1.0),
        high_frequency_weight_stage3=clamp_float(high_frequency_weight_stage3, 0.0, 1.0),
        low_frequency_weight_stage1=clamp_float(low_frequency_weight_stage1, 0.0, 1.0),
        low_frequency_weight_stage2=clamp_float(low_frequency_weight_stage2, 0.0, 1.0),
        low_frequency_weight_stage3=clamp_float(low_frequency_weight_stage3, 0.0, 1.0),
