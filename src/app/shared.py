...
def build_training_params(
    *,
    ...
    lr_schedule_stage1_step: int = 2000,
    lr_schedule_stage2_step: int = 5000,
    ...
    depth_ratio_schedule_step1: int = 1000,
    depth_ratio_schedule_step2: int = 2000,
    depth_ratio_schedule_step3: int = 5000,
    position_random_step_noise_end_step: int = 30_000,
    sh_start_step: int = 5000,
    ...
    training = TrainingHyperParams(
        ...
        depth_ratio_schedule_step1=clamp_int(depth_ratio_schedule_step1, 0, 1_000_000_000),
        depth_ratio_schedule_step2=clamp_int(depth_ratio_schedule_step2, 0, 1_000_000_000),
        depth_ratio_schedule_step3=clamp_int(depth_ratio_schedule_step3, 0, 1_000_000_000),
        position_random_step_noise_end_step=clamp_int(position_random_step_noise_end_step, 0, 1_000_000_000),
        sh_start_step=clamp_int(sh_start_step, 0, 1_000_000_000),
