...
def build_training_params(
    *,
    ...
    training = TrainingHyperParams(
        ...
        position_push_away_from_camera_step=clamp_float(position_push_away_from_camera_step, -1e4, 1e4),
        position_push_away_from_camera_step_stage1=clamp_float(position_push_away_from_camera_step_stage1, -1e4, 1e4),
        position_push_away_from_camera_step_stage2=clamp_float(position_push_away_from_camera_step_stage2, -1e4, 1e4),
        position_push_away_from_camera_step_stage3=clamp_float(position_push_away_from_camera_step_stage3, -1e4, 1e4),
        position_push_away_from_camera_step_stage4=clamp_float(position_push_away_from_camera_step_stage4, -1e4, 1e4),
        ...
        refinement_contribution_area_exponent=clamp_float(refinement_contribution_area_exponent, 0.0, 16.0),
        refinement_contribution_view_count_exponent=clamp_float(refinement_contribution_view_count_exponent, 0.0, 16.0),
