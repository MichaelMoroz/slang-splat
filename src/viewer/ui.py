...
_TRAIN_SETUP_SPECS = (
    ...
    ControlSpec("refinement_loss_weight", "input_float", "Refinement Loss Weight", {"value": 0.01, "step": 1e-3, "step_fast": 1e-2, "format": "%.6f"}),
    ControlSpec("refinement_target_edge_weight", "input_float", "Refinement Edge Weight", {"value": 0.99, "step": 1e-3, "step_fast": 1e-2, "format": "%.6f"}),
