...
class ToolkitWindow:
    ...
    _TOOLTIPS = {
        ...
        "ssim_weight": "DSSIM weight in the four-term RGB image loss; normal L1 receives the remaining normalized weight",
        "high_frequency_weight": "L1 weight for rendered-target residuals after subtracting blurred means",
        "low_frequency_weight": "L1 weight for blurred rendered and target means",
