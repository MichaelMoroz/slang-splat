...
class SplatViewer(spy.AppWindow):
    ...
    def renderer_params(self, allow_debug_overlays: bool) -> RendererParams:
        ...
        return RendererParams(
            ...
            cached_raster_grad_fixed_log_l_diag_range=float(self.c("cached_raster_grad_fixed_log_l_diag_range").value),
            cached_raster_grad_fixed_l_offdiag_range=float(self.c("cached_raster_grad_fixed_l_offdiag_range").value),
