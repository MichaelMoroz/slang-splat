...
_TRAINING_PARAM_KEYS = {
    ...
    "lr_sh_mul": "lr_sh_mul",
    "lr_sh_stage1_mul": "lr_sh_stage1_mul",
    "lr_sh_stage2_mul": "lr_sh_stage2_mul",
    "lr_sh_stage3_mul": "lr_sh_stage3_mul",
    ...
    "color_non_negative_reg": "color_non_negative_reg",
    "depth_ratio_weight": "depth_ratio_weight",
    "ssim_weight": "ssim_weight",
    "ssim_c1": "ssim_c1",
    "ssim_c2": "ssim_c2",
    "refinement_loss_weight": "refinement_loss_weight",
    "refinement_target_edge_weight": "refinement_target_edge_weight",
    ...
    "lr_schedule_stage1_lr": "lr_schedule_stage1_lr",
    "lr_schedule_stage2_lr": "lr_schedule_stage2_lr",
    "lr_schedule_end_lr": "lr_schedule_end_lr",
    "lr_schedule_steps": "lr_schedule_steps",
    "lr_schedule_stage1_step": "lr_schedule_stage1_step",
    "lr_schedule_stage2_step": "lr_schedule_stage2_step",
    "refinement_interval": "refinement_interval",
    "refinement_growth_ratio": "refinement_growth_ratio",
    "refinement_growth_start_step": "refinement_growth_start_step",
    ...
    "refinement_opacity_mul": "refinement_opacity_mul",
