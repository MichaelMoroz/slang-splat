...
_TRAINING_PARAM_KEYS = {
    ...
    "depth_ratio_schedule_step1": "depth_ratio_schedule_step1",
    "depth_ratio_schedule_step2": "depth_ratio_schedule_step2",
    "depth_ratio_schedule_step3": "depth_ratio_schedule_step3",
    "position_random_step_noise_end_step": "position_random_step_noise_end_step",
    "sh_start_step": "sh_start_step",
