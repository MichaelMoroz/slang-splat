...
UI_TOOLTIPS = {
    ...
    **renderer_param_tooltips(),
    ...
    "position_push_away_from_camera_step": "Stage 0 per-step camera-position regularization multiplier; positive values push away and negative values pull toward the camera when scheduling is disabled",
    ...
    **{f"position_push_away_from_camera_step_stage{stage}": f"Signed camera-position regularization target reached at the end of Stage {stage}; positive pushes away and negative pulls toward the camera" for stage in (1, 2, 3, 4)},
