...
GROUP_SPECS = {
    ...
    "Camera": (
        ...
        ControlSpec("camera_free_mode", "checkbox", "Free Camera", {"value": bool(_VIEWER_CONTROL_DEFAULTS.get("camera_free_mode", False))}),
...
_VIEWER_IMPORT_EXPORT_FIELDS = (
    ...
    ("colmap_dataset_residency", str),
    ("colmap_dataset_compression_threads", int),
    ("colmap_max_pose_subset", int),
    ("colmap_use_alpha_masks", bool),
    ("colmap_fisheye_mask_fov", float),
    ...
    ("colmap_pointcloud_refinable", bool),
    ...
    ("colmap_custom_mesh_refinable", bool),
    ...
    ("colmap_fibonacci_sphere_refinable", bool),
...
UI_TOOLTIPS = {
    ...
    **renderer_param_tooltips(),
    ...
    "schedule_stretch": "Time-dilate every step-anchored schedule: stage boundaries, schedule end, refinement start/interval, and the auto-downscale ladder all fire at their authored step times this factor (1.0 = authored schedule). Auto-suggested from the dataset frame count at COLMAP import: each doubling over 100 frames adds 1 (100 -> 1x, 200 -> 2x, 400 -> 3x)",
    ...
    "refinement_max_growth_per_step": "Cap clone-driven scene growth per refinement pass; 0.30 allows at most 30% survivor growth in one pass",
