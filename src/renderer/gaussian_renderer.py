...
class GaussianRenderer:
    ...
    def __init__(
        ...
        self.debug_show_ellipses, self.debug_show_processed_count = bool(debug_show_ellipses), bool(debug_show_processed_count)
